...
export default function Footer() {
  return (
    <footer className="py-16 bg-app-gray-800">
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-[auto_1fr_auto] gap-y-10 gap-x-28">
        <div className="flex flex-col md:justify-between items-center md:items-stretch gap-y-6">
          <a href="#">
            <ManageLogo />
          </a>
          <nav>
            <h2 className="sr-only">Social Media</h2>
            <ul className="flex flex-wrap gap-8 md:gap-3">
              <li>
                <SocialLink href="#" src={facebook} alt="facebook" />
              </li>
              <li>
                <SocialLink href="#" src={youtube} alt="tyoutube" />
              </li>
              <li>
                <SocialLink href="#" src={twitter} alt="twitter" />
              </li>
              <li>
                <SocialLink href="#" src={pinterest} alt="pinterest" />
              </li>
              <li>
        ...
        <nav className="columns-2 md:columns-1 lg:columns-2 space-y-4">
        ...
        <div className="flex flex-col items-center gap-y-5">
          <div className="flex gap-2 w-full flex-wrap">
            <div className="flex-1 flex flex-col"><Input placeholder="Updates in your inbox..." /></div>
            <Button noShadow>Go</Button>
          </div>
          <p className="text-sm text-app-gray-200">
...
function FooterLink({
  ...
  return (
    <a
      href={href}
      className="block text-app-gray-100 transition-colors duration-100 hover:text-app-orange-400 text-sm"
    >
      {children}
    </a>
  );
